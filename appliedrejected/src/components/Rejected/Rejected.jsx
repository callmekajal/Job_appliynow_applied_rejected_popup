...
<div className="w-[311px] h-screen fixed top-0 left-0 " style={{ boxShadow: '0.40px 0 3px rgba(0,0,0,0.25)' }}>
...
<div className="flex flex-row mt-7 mx-6 gap-4 items-center">
  <img src={carrier} alt="carrier" height="24" width="24" />
  <div className="text-[16px] font-poppings font-medium text-[rgba(103,96,106,1)]">Career Guidance</div>
</div>

<div className="flex flex-row mt-7 mx-6 gap-4 items-center">
  <img src={setting} alt="settings" height="24" width="24" />
...
<div className='w-[207px] h-[37px] rounded-md  bg-[rgba(220,53,69,1)] flex items-center mx-3.5 mt-3 text-center justify-center'>
 
    <h1 className='text-[12px] font-poppins text-white font-normal '> Rejected
    </h1>
